                            ...
                            {activeTabIndex === 0 && (
                                <div className="" id="letter" role="tabpanel" aria-labelledby="letter-tab">
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <p className="text-slate-400 mt-3">Most buyers think the first step is finding their dream house, but the truth is finding the funding is the first step. Propiedades del Sol streamlines the Loan Pre-Approval process with our ecosystem of Premier Partners or simply upload your own Pre-Approval letter.</p>
                                    </div>
                                </div>
                            )}
                            {activeTabIndex === 1 && (
                                <div id="schedule" role="tabpanel" aria-labelledby="schedule-tab">
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <p className="text-slate-400 mt-3">Propiedades del Sol allows a buyer to schedule an instant showing and gain a private viewing without the need for multiple parties to be involved. You pick the time that works for you!</p>
                                    </div>
                                </div>
                            )}
                            {activeTabIndex === 2 && (
                                <div id="offer" role="tabpanel" aria-labelledby="offer-tab">
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <p className="text-slate-400 mt-3">Propiedades del Sol walks a buyer through the purchase agreement process making the paperwork appear effortless. With our custom workflows and progress analytics, you will always know where your purchase stands. No more phone tag and unreturned emails!</p>
                                    </div>
                                </div>
                            )}
                            {activeTabIndex === 3 && (
                                <div id="inspection" role="tabpanel" aria-labelledby="inspection-tab">
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <p className="text-slate-400 mt-3">No one wants to buy a lemon. Book an inspection with a licensed inspector, then submit the repair requests all via the Propiedades del Sol platform.</p>
                                    </div>
                                </div>
                            )}
                            {activeTabIndex === 4 && (
                                <div id="appraisal" role="tabpanel" aria-labelledby="appraisal-tab">
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <p className="text-slate-400 mt-3">Propiedades del Sol monitors the appraisal process ensuring the home you are purchasing meets or exceeds the price you are paying.</p>
                                    </div>
                                </div>
                            )}
                            {activeTabIndex === 5 && (
                                <div id="closing" role="tabpanel" aria-labelledby="closing-tab">
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <p className="text-slate-400 mt-3">Finally the closing packet is sent to the Title office, and the day has come… You have Propiedades del Sol the home of your dreams!</p>
                                    </div>
                                </div>
                            )}
                        </div>
