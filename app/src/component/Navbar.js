        ...
        >
          ...
          <div id="navigation" style={{ display: toggle ? 'block' : 'none' }}>
            ...
            <ul className={`navigation-menu  ${navClass === '' || navClass === undefined ? '' : 'nav-light'}   ${topnavClass !== '' && topnavClass !== undefined ? 'justify-center' : 'justify-end'}`}>
              <li className={manu === "/buy" ? 'active' : ''}><NavLink to="/buy" activeclassname="active" className="sub-menu-item">Lotes Costa Rica 🇨🇷</NavLink></li>
              ...
              {/* <li className={`has-submenu parent-menu-item ${["/", "/index", "/index-two", "/index-three", "/index-four", "/index-five", "/index-six", "/index-seven"].includes(manu) ? 'active' : ''}`}>
                                ...
                                <ul className={`submenu ${["/index", "/index-two", "/index-three", "/index-four", "/index-five", "/index-six", "/index-seven", "/index-item"].includes(subManu) ? 'open' : ''}`}>
                                    ...
                                    <li className={manu === "/index-seven" ? 'active' : ''}><Link to="/index-seven" className="sub-menu-item">Hero Seven <span className="bg-yellow-500 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">New</span></Link></li>
                                </ul>
                            </li> */}

              {/* <li className={`has-submenu parent-parent-menu-item ${["/grid", "/grid-sidebar", "/grid-map", "/list", "/list-sidebar", "/list-map", "/land-detail/1"].includes(manu) ? 'active' : ''}`}>
                                <Link to="#" onClick={() => { setSubManu(subManu === "/list-item" ? "" : "/list-item") }}>Listing</Link><span className="menu-arrow"></span>
                                <ul className={`submenu ${["/grid", "/grid-sidebar", "/grid-map", "/list", "/list-sidebar", "/list-map", "/land-detail/1", "/list-item", "/grid-item", "/list-view-item", "/property-item"].includes(subManu) ? 'open' : ''}`}>
                                    ...
                                    <li className={`has-submenu parent-menu-item ${["/land-detail/1"].includes(manu) ? 'active' : ''}`}><Link to="#" onClick={() => { setSubManu(subManu === "/property-item" ? "" : "/property-item") }}> Property Detail </Link><span className="submenu-arrow"></span>
                                        <ul className={`submenu ${["/land-detail/1", "/property-item"].includes(subManu) ? 'open' : ''}`}>
                                            <li className={manu === "/land-detail/1" ? 'active' : ''}><Link to="/land-detail/1" className="sub-menu-item">Property Detail</Link></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li> */}
