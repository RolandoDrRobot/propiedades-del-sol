      ...
      <div className="container lg:mt-24 mt-16">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-2 gap-[30px]">
          {propertiesLand.map((item, index) => (
            <div className="group rounded-xl bg-white dark:bg-slate-900 hover:shadow-xl dark:hover:shadow-xl overflow-hidden ease-in-out duration-500" key={index}>
              <div className="relative property-pic">
                <img className="shadow dark:shadow-gray-700" src={item.image} alt="" />
                {/* 
