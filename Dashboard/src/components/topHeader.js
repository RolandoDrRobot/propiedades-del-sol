                ...
                <ul className="list-none mb-0 space-x-1">
                    ...
                    <li className="dropdown inline-block relative">
                        <button className="dropdown-toggle h-8 w-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-[20px] text-center bg-gray-50 dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 border border-gray-100 dark:border-gray-800 text-slate-900 dark:text-white rounded-md" type="button" onClick={() =>setShowCountry(true)}>
                            <img src={usa} className="h-6 w-6 rounded-md" alt=""/>
                        </button>
                        ...
                        <div className={`${showCountry ? 'show' : 'hidden'} dropdown-menu absolute end-0 m-0 mt-4 z-10 w-36 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow dark:shadow-gray-700`}>
                            <ul className="list-none py-2 text-start">
                                <li className="my-1 ms-0">
                                    <Link to="" className="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-green-600 dark:hover:text-white"><img src={germany} className="h-6 w-6 rounded-md me-2 shadow dark:shadow-gray-700" alt=""/> German</Link>
                                </li>
                                <li className="my-1 ms-0">
                                    <Link to="" className="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-green-600 dark:hover:text-white"><img src={italy} className="h-6 w-6 rounded-md me-2 shadow dark:shadow-gray-700" alt=""/> Italian</Link>
                                </li>
                                <li className="my-1 ms-0">
                                    <Link to="" className="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-green-600 dark:hover:text-white"><img src={russia} className="h-6 w-6 rounded-md me-2 shadow dark:shadow-gray-700" alt=""/> Russian</Link>
                                </li>
                                <li className="my-1 ms-0">
                                    <Link to="" className="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-green-600 dark:hover:text-white"><img src={spain} className="h-6 w-6 rounded-md me-2 shadow dark:shadow-gray-700" alt=""/> Spanish</Link>
                                </li>
                            </ul>
                        </div>
                    </li>
                            ...
                            <SimpleBar className="h-64">
                                <ul className="py-2 text-start h-64 border-t border-gray-100 dark:border-gray-800">
                                    ...
                                    <li className="ms-0">
                                        <Link to="#!" className="block font-medium py-1.5 px-4">
                                            <div className="flex items-center">
                                                <img src={client4} className="h-10 w-10 rounded-md shadow dark:shadow-gray-700" alt=""/>
                                                <div className="ms-2">
                                    ...
                                    <li className="ms-0">
                                        <Link to="#!" className="block font-medium py-1.5 px-4">
                                            <div className="flex items-center">
                                                <img src={client5} className="h-10 w-10 rounded-md shadow dark:shadow-gray-700" alt=""/>
                                                <div className="ms-2">
