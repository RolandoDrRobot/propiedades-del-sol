                    ...
                    <div className="xl:col-span-3 lg:col-span-5 md:col-span-5">
                        <div className="rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900">
                            <div className="text-center p-6 border-b border-gray-100 dark:border-gray-800">
                                <img src={client7} className="h-20 w-20 rounded-full shadow dark:shadow-gray-700 mx-auto" alt=""/>
                                        ...
                                        <div className="inline-block">
                                            <div className="flex mb-3">
                                                <div className="relative order-2">
                                                    <img src={client7} className="h-9 w-9 min-w-[36px] rounded-full shadow dark:shadow-gray-700" alt=""/>
                                    ...
                                    <li className="text-end">
                                        <div className="inline-block">
                                            <div className="flex mb-3">
                                                ...
                                                <div className="me-2 max-w-lg">
                                                    <p className="bg-white dark:bg-slate-900 text-slate-400 text-[16px] shadow dark:shadow-gray-700 px-3 py-2 rounded mb-1">Sure please check below link to find more useful information <Link to="https://shreethemes.in/Sun Real Estate/" target="_blank" className="text-green-600">https://shreethemes.in/Sun Real Estate/</Link></p>
                            ...
                            <div className="p-2 border-t border-gray-100 dark:border-gray-800">
                                <div className="flex ">
                                    ...
                                    <div className="min-w-[125px] text-end">
                                        <Link to="#" className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-[16px] text-center bg-green-600 hover:bg-green-700 border-green-600 hover:border-green-700 text-white rounded-md"><i className="mdi mdi-send"></i></Link>
                                        <Link to="#" className="h-9 w-9 mx-1 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-[16px] text-center bg-green-600 hover:bg-green-700 border-green-600 hover:border-green-700 text-white rounded-md"><i className="mdi mdi-emoticon-happy-outline"></i></Link>
                                        <Link to="#" className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-[16px] text-center bg-green-600 hover:bg-green-700 border-green-600 hover:border-green-700 text-white rounded-md"><i className="mdi mdi-paperclip"></i></Link>
                                    </div>
                                </div>
                            </div>
                        </div>
