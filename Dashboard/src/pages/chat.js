                                    ...
                                    <li className="text-end">
                                        <div className="inline-block">
                                            <div className="flex mb-3">
                                                ...
                                                <div className="me-2 max-w-lg">
                                                    <p className="bg-white dark:bg-slate-900 text-slate-400 text-[16px] shadow dark:shadow-gray-700 px-3 py-2 rounded mb-1">Sure please check below link to find more useful information <Link to="https://shreethemes.in/Propiedades del Sol/" target="_blank" className="text-green-600">https://shreethemes.in/Propiedades del Sol/</Link></p>
